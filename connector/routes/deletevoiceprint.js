...
const debug = require('debug')('connector:routes:deletevoiceprint');
...
router.get('/', (req, res, next) => {
  ...
  debug(`Deleting Voiceprint for ${cleanPhone}`);
  ...
  avClient.delete(cleanPhone, avClient.VoiceprintType.DIGIT).then( (resp) => {
